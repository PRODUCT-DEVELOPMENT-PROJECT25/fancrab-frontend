...
import com.example.fancrabbackened.repository.OrderRepository;
import com.example.fancrabbackened.response.ApiResponse;
import com.example.fancrabbackened.response.PaymentLinkResponse;
import com.example.fancrabbackened.service.OrderService;
import com.example.fancrabbackened.service.UserService;
import com.example.fancrabbackened.user.domain.OrderStatus;
import com.example.fancrabbackened.user.domain.PaymentStatus;
...
public class PaymentController {
	   ...
	   @Value("rzp_test_ir70APZMI1KUDB")
	    private String apiKey;

	    @Value("YlvKTXTkPe8FRQrMN96sJtll")
...
//			order.setOrderItems(order.getOrderItems());
		...
		new RedirectView("https://shopwithFancrab.vercel.app/payment/failed");
		throw new RazorpayException(e.getMessage());
	}
