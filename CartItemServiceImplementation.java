...
import com.example.fancrab_backened.repository.CartItemRepository;
import com.example.fancrab_backened.repository.CartRepository;
...
public class CartItemServiceImplementation implements CartItemService {
    ...
    public void removeCartItem(Long userId, Long cartItemId) throws CartItemException, UserException {
        ...
        User owner = cartItem.getCart().getUser(); // Assumes CartItem has a User reference
